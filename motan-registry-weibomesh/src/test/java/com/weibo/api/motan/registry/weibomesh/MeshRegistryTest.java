...
public class MeshRegistryTest {
    ...
    private static Map<String, String> getModifiableEnvironment() throws Exception {
        ...
        final Map<String, String> env = (Map<String, String>) m.get(unmodifiableEnvironment);
        ...
        if (caseInsensitiveEnv == null) {
            return env;
        }
        final Map<String, String> secondary = caseInsensitiveEnv;
